...
public class RabbitMQConfig {
    ...
    //添加选课消息队列
    public static final String XC_LEARNING_DDCHOOSECOURSE = "xc_learning_addchoosecourse";
    //添加选课路由key
    ...
    @Bean(XC_LEARNING_DDCHOOSECOURSE)
    public Queue QUEUE_DECLARE1() {
        Queue queue = new Queue(XC_LEARNING_DDCHOOSECOURSE,true,false,true);
        return queue;
    }
    /**
     * 绑定队列到交换机 .
